    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "the workstream runs in program work_mode). If the call is "
                "refused by the consent gate, run "
                "ask_user_choice(kind='execution_mode') FIRST and consult "
                "again after the user picks program — NEVER surface the "
                "refusal error to the user. WHEN NOT: a one-sitting build "
                "is ONE fat task (Tier 1b); 2-3 related tasks are a "
                "depends_on chain; a SINGLE-scope body of work skips "
